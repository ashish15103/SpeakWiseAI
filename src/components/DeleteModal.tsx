export function DeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4 backdrop-blur-[2px] transition-opacity">
      {/* Modal Container: adjusted to rounded-2xl for that clean rectangular look */}
      <div className="w-full max-w-[420px] rounded-2xl bg-white p-6 shadow-2xl dark:border dark:border-gray-800 dark:bg-gray-900">
        ...
        {/* The extra "Visit settings..." text has been completely removed */}
        <p className="mt-4 text-[15px] text-gray-800 dark:text-gray-200">
          This will delete <span className="font-bold">{chatTitle}</span>.
        </p>
        ...
        <div className="mt-8 flex justify-end gap-3">
          ...
          {/* Delete Button with the distinct black border */}
          <button
            onClick={onConfirm}
